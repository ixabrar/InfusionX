// Setup Data for Leaderboard
// Copy and paste this into browser DevTools Console to load all participants
...
localStorage.setItem('arena-last-participant-id', '49');
...
console.log('✅ Loaded', blindCodingData.length, 'Blind Coding participants');
console.log('✅ Loaded', promptverseData.length, 'Promptverse participants');
