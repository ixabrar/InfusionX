export default function EventSwitcher({ currentEvent, onSwitchEvent }) {
  return (
    <section id="events" className="px-10 py-[60px] max-w-[1200px] mx-auto">
      ...
      <div
        className="flex gap-1 rounded-[8px] p-1 w-fit"
        style={{
      ...
      >
        <button
          ...
          className="font-mono text-xs tracking-[0.2em] uppercase px-8 py-3 rounded transition-all duration-300"
          style={{
