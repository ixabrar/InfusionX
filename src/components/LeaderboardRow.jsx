export default function LeaderboardRow({ person, rank, percentage, currentEvent }) {
  ...
  return (
    <div
      className="flex items-center gap-5 px-6 py-[18px] rounded-[10px] cursor-pointer transition-all duration-300 relative overflow-hidden group hover-glow"
      style={{
    ...
    >
      ...
      {/* Rank Number */}
      <div
        className={`font-hero text-[36px] tracking-[0.02em] min-w-[60px] leading-none ${
      ...
      {/* Avatar */}
      <div
        className="w-10 h-10 rounded-full flex items-center justify-center font-hero text-base flex-shrink-0"
        style={{
      ...
      <div className="flex-1 min-w-0">
        <div className="font-body text-[15px] font-medium tracking-[0.02em] text-text">
          {person.name}
        </div>
        <div className="font-mono text-[11px] text-muted tracking-[0.1em] mt-0.5">
      ...
      <div className="flex flex-col items-end">
        <div className="font-mono text-[20px] font-bold text-accent min-w-[80px] text-right">
          {person.score}
        </div>
        <div className="font-mono text-[10px] text-muted text-right tracking-[0.15em]">
          POINTS
        </div>
      </div>
    </div>
